...
def PixelCNN3Dlayer(i, X, f_map=8, full_horizontal=True, h=None, filter_size=None, 
                    conditional=None, conditional_im=None, cfilter_size=None, debug=False, gatedact='sigmoid'):
    ...
    with tf.variable_scope("d_stack"+i):
        d_stack = GatedCNN([filter_size, filter_size, filter_size, f_map], 
                           ...
                           conditional_image=conditional_im, cfilter_size=cfilter_size, debug=debug, gatedact=gatedact).output()
