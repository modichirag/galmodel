...
def check_module(modpath):
    ...
    plt.figure()
    plt.hist(vmeshes[100][0]['predict'].flatten(), range=(-5, 5), bins=100, label='predict')
    plt.hist(vmeshes[100][1][tgname[0]].flatten(), alpha=0.5, range=(-5, 5), bins=100, label='target')
    plt.legend()
