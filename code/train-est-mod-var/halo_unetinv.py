#inverse changes the order of meshes returned by get_meshes and hence the features are halos
#and the target is density. We also change distribution to normal. Everything else is the same
        ...
        def _model_fn(features, labels, mode):
            return models._mdn_unetmodel_fn(features, labels, 
                                 nchannels, n_y, n_mixture, dropout,
                                                  optimizer, mode, pad=pad, fsize=fsize, nsub=nsub, distribution='normal')
