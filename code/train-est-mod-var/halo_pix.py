...
def get_meshes(seed, galaxies=False, inverse=False):
    mesh = {}
...
def check_module(modpath):
    ...
    dosampletrue = False
    if max_steps in [50, 100, 500, 1000, 5000, 15000, 25000]:
        dosampletrue = True
        csize = 16
    if max_steps in [3000, 10000, 20000, 30000]:
        dosampletrue = True
        csize = 32
