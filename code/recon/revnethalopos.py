##Reconstruct from revnet. Its not really different, so can use other file, but well.
...
#modpath = '/home/chmodi/Projects/galmodel/notebooks/models/n10/rev-nn-l2/module/1548392154/likelihood/'
#modpath = '/home/chmodi/Projects/galmodel/code/models/n10/rev_nn_l2/module/1548456835/likelihood/'
#modpath = '/home/chmodi/Projects/galmodel/code/models/n10/rev_cic_l2/module/1548395015/likelihood/'
modpath = '/home/chmodi/Projects/galmodel/notebooks/models/n10/rev-SN/module/1548733709/likelihood/'
modpath = '/home/chmodi/Projects/galmodel/notebooks/models/n10/rev-SN2/module/1548795689/likelihood/'
resnorm = 0
#suffix = 'nc%dnorm-fpm/'%(resnorm)
suffix = 'nc%dnorm-rev-nn-l2-SN2/'%(resnorm)
#suffix = 'nc10-4norm-rev-nn-l2_stdinit/'
loss = 'l2'
sample = 'lambda'
binning = 'nn'
...
if __name__=="__main__":
    ...
    recong = rmods.graphhposft1(config, modpath, data, pad,  maxiter=maxiter, gtol=gtol, anneal=anneal, resnorm=resnorm, inference=False,
                                loss=loss, sample=sample)    
    #
